...
> **使い分け:** Vision ワークフローでは `_vision-interview.md` を、それ以外では `_deep-interview.md` を使用。
...
|-------------|-------------------|-----------|
| design.md | Spec 作成後、Multi-Review 前 | **必須** |
| add.md | Feature Spec 作成後、Multi-Review 前 | **必須** |
| fix.md | Fix Spec 作成後、Multi-Review 前 | **必須** |

> **Note:** Vision ワークフローは専用の [_vision-interview.md](_vision-interview.md) を使用。
...
> **Note:** Vision は専用の `_vision-interview.md` を参照。
