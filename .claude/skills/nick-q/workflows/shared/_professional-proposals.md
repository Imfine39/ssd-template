...
context:
- SETUP: project-setup 時の提案
- FEAT: feature ワークフロー時の提案
- REV: review 時の追加提案

例:
- P-SETUP-001: プロジェクト初期設定時の提案 #1
- P-FEAT-001: Feature 追加時の提案 #1
```
...
全提案の採否を `.specify/docs/proposal-log.md` に記録：

```markdown
# Proposal Decision Log

| ID | 日付 | 提案内容 | 採否 | 理由 | 関連 Spec |
|----|------|---------|------|------|-----------|
| P-SETUP-001 | 2026-01-01 | 検索機能 | 採用 | MVP 必須 | S-FEAT-001 |
| P-SETUP-002 | 2026-01-01 | 多言語 | 不採用 | Phase 2 | - |
| P-FEAT-001 | 2026-01-02 | キャッシュ | 要検討 | 測定後 | [DEFERRED] |
```

> **Note:** このログにより、過去の意思決定を参照可能にする。
...
- [_qa-followup.md](_qa-followup.md) - 提案確認の実行フロー
- [_qa-generation.md](_qa-generation.md) - QA ドキュメント生成時の提案
