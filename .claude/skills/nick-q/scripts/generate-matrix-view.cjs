 ...
 *
 * Usage:
 *   node .claude/skills/nick-q/scripts/generate-matrix-view.cjs [options] [path-to-json]
 *
 * Options:
...
Examples:
  ...
  node .claude/skills/nick-q/scripts/generate-matrix-view.cjs .specify/specs/overview/matrix/cross-reference.json
        `);
        process.exit(0);
      default:
