 ...
 *   node .claude/skills/nick-q/scripts/state.cjs repo --set-vision-status approved
 *   node .claude/skills/nick-q/scripts/state.cjs repo --set-phase development
 *   node .claude/skills/nick-q/scripts/state.cjs branch --name feature/5-inventory --set-step implement
 *   node .claude/skills/nick-q/scripts/state.cjs suspend --branch feature/5-inventory --reason spec-change --related 20
 *   node .claude/skills/nick-q/scripts/state.cjs resume --branch feature/5-inventory
 *   node .claude/skills/nick-q/scripts/state.cjs query --repo
 *   node .claude/skills/nick-q/scripts/state.cjs query --branch feature/5-inventory
 *   node .claude/skills/nick-q/scripts/state.cjs query --suspended
 */
...
function cmdQuery(args) {
  ...
  if (queryRepo || queryAll) {
    ...
    if (repoState) {
      ...
      console.log('Repo state not initialized. Run: node .claude/skills/nick-q/scripts/state.cjs init');
    }
  }
  ...
  if (queryBranch || queryAll) {
    ...
    if (branchState) {
      ...
      console.log('Branch state not initialized. Run: node .claude/skills/nick-q/scripts/state.cjs init');
    }
  }
...
Usage:
  node .claude/skills/nick-q/scripts/state.cjs <command> [options]
