...
```bash
# [FUTURE] node .claude/skills/nick-q/scripts/state.cjs branch --add-checkpoint spec_approval
```
...
```bash
# [FUTURE] node .claude/skills/nick-q/scripts/state.cjs branch --add-checkpoint plan_approval
```
...
```bash
# [FUTURE] node .claude/skills/nick-q/scripts/state.cjs branch --add-checkpoint decision_{type}
```
...
```bash
# [FUTURE] node .claude/skills/nick-q/scripts/state.cjs branch --add-checkpoint {checkpoint_type}
```
